        ...
        <div class="site-container account-container">
            <div class="surface account-card">
                <div class="section-head mb-24">
                    <div>
                        <h1 class="section-title">아이디 찾기</h1>
                ...
                <form id="findIdForm" class="account-form" onsubmit="return false;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="memberName" name="memberName" class="input-control" placeholder="이름을 입력하세요">
                    ...
                    <div id="resultBox" class="hidden account-result">
                        <p class="result-text">회원님의 아이디는 다음과 같습니다.</p>
                        <p class="result-id" id="foundMemberId"></p>
                    </div>

                    <!-- 5. 제출 버튼 -->
                    <button type="button" id="btnSubmit" class="button btn-full mt-8" onclick="findIdSubmit()">아이디 찾기</button>
                </form>

                <div class="account-links">
                    <a class="text-link" href="${ctx}/member/findPassword">비밀번호 찾기</a>
...
<script>
    ...
    function sendAuthCode() {
        ...
        fetch(`${CTX}/api/member/find-id/send-code`, {
            method: 'POST',
