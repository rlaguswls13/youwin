                            ...
                            <c:choose>
                                <c:when test="${not empty room}">
                                    <p><span class="online-dot">●</span>
                                        <span id="room-member-count">${fn:length(memberList)}명 참여 중</span>  · ${room.roomDescription}
                                    </p>
                            ...
                            <div class="message ${message.memberId == loginMemberId ? 'my-message' : 'other-message'}"
                                ...
                                <div class="message__body">
                                    ...
                                    <div class="message__row">
                                        ...
                                        <c:if test="${message.memberId == loginMemberId}">
                                            <div class="message-read" data-message-id="${message.messageId}">
                                                <c:choose>
                                                    <c:when test="${message.unreadCount == 0}">읽음</c:when>
                                                    <c:otherwise>${message.unreadCount}</c:otherwise>
                                                </c:choose>
                                            </div>
                                        </c:if>
                                    </div>
